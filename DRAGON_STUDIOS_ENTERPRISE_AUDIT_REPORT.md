...
| :--- | :--- | :--- |
| **Database Name** | `dragon_db` | **VERIFIED** |
| **Database Engine** | PostgreSQL 16+ | **VERIFIED** |
| **Host / Port** | `localhost:5432` | **VERIFIED** |
| **Database Schema** | `public` | **VERIFIED** |
| **Database User** | `postgres` | **VERIFIED** |
| **Connection String (`.env`)** | `postgresql://postgres:123456654321@localhost:5432/dragon_db?schema=public` | **VERIFIED IDENTICAL** |
