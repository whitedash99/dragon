...
export function Preloader() {
  ...
  const [statusText, setStatusText] = useState(
    "Initializing DragonOS Engine..."
  );

  // Wait until client mounts to avoid hydration mismatch
  useEffect(() => {
    setMounted(true);
    ...
    try {
      ...
      const visited = sessionStorage.getItem("dragon_visited_session");
      setLoading(!visited);
    } catch {
      setLoading(false);
    }
