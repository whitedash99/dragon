...
export const communityEvents: CommunityEvent[] = [
  {
    id: "evt-1",
    title: "Neon Drift Community Racing Showcase",
    type: "Tournament",
    date: "Upcoming",
    countdownText: "Open Registration",
    registeredPlayers: "Live Registry",
    prizePool: "Alpha Access Pass & Beta Tester Badge",
    description: "16-player bracket anti-gravity showcase with live developer participation.",
  },
  {
    id: "evt-2",
    title: "Dragon Engine Architecture Deep Dive",
    type: "Dev Livestream",
    date: "Monthly Dispatch",
    countdownText: "Live Stream",
    registeredPlayers: "Community RSVP",
    streamUrl: "https://twitch.tv/dragonstudios",
    description: "Join the Dragon Studios core team as they unveil next-gen graphics pipelines and physics.",
  },
];
...
export const creatorsList: CreatorProfile[] = [
  {
    ...
    bio: "Action RPG speedrunner & competitive racer streaming Dragon Studios builds.",
  },
  {
    id: "cr-2",
    ...
    verified: true,
    topGame: "Dragon Slayer 3D",
    bio: "Action gameplay strategist breaking down combat mechanics and boss fight guides.",
  },
];
