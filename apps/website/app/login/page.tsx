...
import { Lock, Mail, ArrowRight, Sparkles, RefreshCw, Globe, ShieldCheck } from "lucide-react";
          ...
          >
            ...
            <div className="text-center space-y-3">
              ...
              <h1 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-white font-heading">
                DRAGON<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#7C3CFF]">ID</span> PORTAL
              </h1>
              <p className="text-xs text-slate-400 font-mono leading-relaxed">
                Centralized authentication for studio games, downloads & player command center.
              </p>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs rounded-xl shadow-lg transition-all border border-slate-200 cursor-pointer active:scale-95"
              >
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer text-xs text-slate-400">
                  <input
                    ...
                    className="rounded border-white/10 bg-black/60 text-cyan-400 focus:ring-0"
                  />
                  <span className="text-[11px] font-mono">Trust this operative device</span>
                </label>
              </div>
            ...
            <div className="mt-8 border-t border-white/10 pt-6 text-center text-xs text-slate-400 font-mono">
