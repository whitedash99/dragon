...
export default function Icon() {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="180" height="180">
    <rect width="128" height="128" rx="32" fill="#02050f" stroke="#00f0ff" stroke-width="4"/>
