...
| :--- | :--- | :--- |
| **Public Website Env (`D:\dragon\.env`)** | `postgresql://neondb_owner:npg_PLneOSAEjJ36@ep-still-brook-az2n4i12.c-3.ap-southeast-1.aws.neon.tech/neondb?sslmode=require` | **VERIFIED MATCH** |
| **Admin Panel Env (`D:\dragon-admin\.env`)** | `postgresql://neondb_owner:npg_PLneOSAEjJ36@ep-still-brook-az2n4i12.c-3.ap-southeast-1.aws.neon.tech/neondb?sslmode=require` | **VERIFIED MATCH** |
| **Database Target Name** | `neondb` | **CONFIRMED SINGLE DB** |
