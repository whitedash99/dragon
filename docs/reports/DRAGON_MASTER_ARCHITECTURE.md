...
* **Engine**: PostgreSQL 16+ (Neon Cloud Serverless)
* **Connection Endpoint**: `ep-still-brook-az2n4i12.c-3.ap-southeast-1.aws.neon.tech`
* **Database Connection String**: `postgresql://neondb_owner:npg_PLneOSAEjJ36@ep-still-brook-az2n4i12.c-3.ap-southeast-1.aws.neon.tech/neondb?sslmode=require`
