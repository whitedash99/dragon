...
* **Database Target**: `postgresql://postgres:***@localhost:5432/dragon_db?schema=public`
...
* `D:\dragon\.env`: `DATABASE_URL="postgresql://postgres:123456654321@localhost:5432/dragon_db?schema=public"`
* `D:\dragon-admin\.env`: `DATABASE_URL="postgresql://postgres:123456654321@localhost:5432/dragon_db?schema=public"`
